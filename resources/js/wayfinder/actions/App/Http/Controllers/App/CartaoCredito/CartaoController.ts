...
/**
* @see \App\Http\Controllers\App\CartaoCredito\CartaoController::index
...
const CartaoController = { index, create, store, show, edit, update, destroy, arquivar, desarquivar }

...
/**
* @see \App\Http\Controllers\App\Lancamento\LancamentoController::alterarStatus
* @see app/Http/Controllers/App/Lancamento/LancamentoController.php:87
* @route '/app/lancamentos/{id}/status'
*/
export const alterarStatus = (args: { id: string | number } | [id: string | number ] | string | number, options?: RouteQueryOptions): RouteDefinition<'patch'> => ({
    url: alterarStatus.url(args, options),
    method: 'patch',
})

alterarStatus.definition = {
    methods: ["patch"],
...
* @route '/app/lancamentos/{id}/status'
*/
alterarStatus.url = (args: { id: string | number } | [id: string | number ] | string | number, options?: RouteQueryOptions) => {
    if (typeof args === 'string' || typeof args === 'number') {
        args = { id: args }
    }
    ...
    return alterarStatus.definition.url
            .replace('{id}', parsedArgs.id.toString())
            .replace(/\/+$/, '') + queryParams(options)
}
...
* @route '/app/lancamentos/{id}/status'
*/
alterarStatus.patch = (args: { id: string | number } | [id: string | number ] | string | number, options?: RouteQueryOptions): RouteDefinition<'patch'> => ({
    url: alterarStatus.url(args, options),
    method: 'patch',
})
...
const LancamentoController = { index, create, despesa, receita, transferencia, show, edit, update, destroy, alterarStatus, conciliar, copiar }
